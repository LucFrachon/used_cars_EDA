...
Let's split the data in two with a cut-off in 1992 (24 years ago):

```{r include = FALSE}
cars[yearOfRegistration <= 1992, collector_status := 'vintage']
cars[(yearOfRegistration > 1992) & (!is.na(yearOfRegistration)), collector_status := 'modern']
...
We also notice a group of observations at 0 kilometers between 1995 and 2005 approximately, that do not seem to follow the general distribution. Since that period is precisely the one with the highest density of observations in the dataset, I suspect these cars actually have a much higher mileage and that the data is wrong.
